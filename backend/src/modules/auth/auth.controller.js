...
class AuthController {
  ...
  updatePreferences = catchAsync(async (req, res) => {
    const updatedUser = await authService.updatePreferences(req.user._id, req.body);

    ApiResponse.success(res, updatedUser, 'Preferences updated successfully');
  });
  ...
  resetPasswordWithOtp = catchAsync(async (req, res) => {
