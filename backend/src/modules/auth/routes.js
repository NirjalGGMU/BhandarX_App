...
router.post('/reset-password-otp', resetPasswordLimiter, resetPasswordOtpValidation, validate, authController.resetPasswordWithOtp);
...
router.put('/preferences', protect, updateProfileValidation, validate, authController.updatePreferences);
