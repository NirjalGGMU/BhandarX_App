        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 40),
              InputField(label: "Email", controller: _emailCtrl, hint: "you@example.com"),
              InputField(label: "Password", controller: _passCtrl, obscureText: !_showPass, showToggle: true, onToggle: () => setState(() => _showPass = !_showPass)),
              InputField(label: "Confirm Password", controller: _confirmCtrl, obscureText: !_showConfirm, showToggle: true, onToggle: () => setState(() => _showConfirm = !_showConfirm)),
              if (_error != null) Padding(padding: const EdgeInsets.all(10), child: Text(_error!, style: const TextStyle(color: Colors.red))),
              const SizedBox(height: 20),
              CustomButton(text: "Create Account", onPressed: _register),
              const SizedBox(height: 20),
              TextButton(onPressed: () => Navigator.pop(context), child: const Text("Already have account? Login", style: TextStyle(color: Color(0xFF3949AB)))),
            ],
          ),
        ),
      ),
